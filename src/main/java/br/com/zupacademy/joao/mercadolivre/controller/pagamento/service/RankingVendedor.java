...
@Service
public class RankingVendedor implements EventoCompraSucesso {
    ...
    public void processar(Compra compra) {
        ...
        Map<String, Object> request = Map.of("idCompra", compra.getId(), "idComprador", compra.getProduto().getDonoDoProduto().getId());
